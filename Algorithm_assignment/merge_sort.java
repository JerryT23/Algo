...
public class merge_sort {
    public static void main(String[] args) {
        ...
        try {
            List<Element> data = readCSV(inputFile);

            long startTime = System.nanoTime();
            mergeSort(data);
            long endTime = System.nanoTime();

            String outputFile = getSortedFilename(inputFile);
    ...
    static String getSortedFilename(String inputFile) {
        String base = inputFile.contains(".") ? inputFile.substring(0, inputFile.lastIndexOf('.')) : inputFile;
